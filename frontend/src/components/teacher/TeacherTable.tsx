      ...
      <div className="flex items-center justify-between mb-6">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-4 py-2 w-64 rounded-full border-border focus:border-purple-500 focus:ring focus:ring-secondary/20 focus:ring-opacity-50 transition-all duration-300"
          />
        </div>
      </div>

      {/* Table rendering */}
      <div className="rounded-md border border-border overflow-hidden transition-shadow duration-300 hover:shadow-md">
        <Table>
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <TableHead
                    key={header.id}
                    className="font-bold text-white dark:text-foreground"
                  >
